...
import com.gracielo.expertsubmission1.databinding.FragmentMovieFavoriteBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (activity != null) {
            ...
            movieFavoriteViewModel.favMovie.observe(viewLifecycleOwner, { listMovie ->
                ...
                binding.viewError.tvError.text = "Something Wrong or Empty Data"
                binding.viewError.root.visibility =
                    if (listMovie.isNotEmpty()) View.GONE else View.VISIBLE
